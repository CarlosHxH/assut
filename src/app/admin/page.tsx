            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
              ...
              <div className="p-6">
                <div className="space-y-4">
                  {[
                    { name: 'João Silva', email: 'joao@email.com', role: 'Admin', status: 'Ativo' },
                    { name: 'Maria Santos', email: 'maria@email.com', role: 'Editor', status: 'Ativo' },
                    { name: 'Pedro Costa', email: 'pedro@email.com', role: 'Usuário', status: 'Inativo' },
                  ].map((user, index) => (
