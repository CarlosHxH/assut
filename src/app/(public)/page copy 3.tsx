        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-3 group">
              <div className="rounded-lg transition-all duration-300 group-hover:scale-110 animate-pulse-glow">
                <Image className="h-12 w-12 rounded-lg transition-transform duration-300 group-hover:rotate-12" height={500} width={500} src={"/logo.png"} alt={'Logo'} />
              </div>
      ...
      < section id="formulario" className="py-20 bg-gray-50 data-animate" >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 animate-fade-in-up">
            <h2 className="text-4xl font-bold text-gray-900 mb-4 transition-all duration-500 hover:text-blue-600">Fale Conosco</h2>
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 transform hover:scale-105 transition-all duration-500 animate-scale-in">
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="group">
                  <label className="block text-sm font-medium text-gray-700 mb-2 transition-colors duration-300 group-focus-within:text-blue-600">
                    Nome Completo
                  </label>
                  <input
                    type="text"
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-4 px-8 rounded-lg font-semibold hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 shadow-lg hover:shadow-blue-500/50 animate-pulse-glow"
              >
