...
import { Menu, X, Bus, FileText, MessageCircle, Users, Phone, Mail, MapPin, ChevronRight, Star, Shield, Clock, Target, CreditCard } from 'lucide-react';
    ...
    <>
      <div className="min-h-screen bg-white">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-4">
              ...
              <nav className="hidden md:flex space-x-8">
                <a href="#home" className="text-blue-600 font-medium hover:text-primary-red transition-all duration-300 relative group">
                  Início
                  <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
                </a>
                <a href="#sobre" className="text-black hover:text-primary-blue transition-all duration-300 relative group">
                  Sobre
                  <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
                </a>
                <a href="#servicos" className="text-black hover:text-primary-blue transition-all duration-300 relative group">
                  Serviços
                  <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
                </a>
                <a href="/carterinha/cadastro" className="text-black hover:text-primary-blue transition-all duration-300 relative group">
                  Carteirinha
                  <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
                </a>
                <a href="#contato" className="text-black hover:text-primary-blue transition-all duration-300 relative group">
                  Contato
                  <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
                </a>
              </nav>
          ...
          {isMenuOpen && (
            <div className="md:hidden bg-white border-t">
              <div className="px-4 py-3 space-y-2">
                ...
                <a href="/carterinha/cadastro" className="block py-2 text-gray-700 hover:text-gray-600">Carteirinha</a>
        ...
        <section id="home" className="relative bg-gradient-to-br from-gray-600 via-gray-700 to-indigo-800 text-white py-20 overflow-hidden">
          <div className="absolute inset-0 bg-black opacity-75" style={{
            backgroundImage: 'url(assets/image/busao-01.jpeg)',
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className={`flex flex-col sm:flex-row gap-4 justify-center transition-all duration-1000 delay-500 animate-fade-in-up`}>
              <a
                href="#formulario"
                className="bg-red-500 text-primary-white px-8 py-4 rounded-full font-semibold hover:bg-primary-white hover:text-primary-red transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 flex items-center justify-center group shadow-2xl hover:shadow-red-500/25"
              >
                Fazer Denúncia
              ...
              <button
                onClick={() => { }}
                className="bg-white text-blue-500 px-8 py-4 rounded-full font-semibold hover:bg-primary-blue hover:text-primary-white transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 shadow-lg hover:shadow-blue-500/25 flex items-center justify-center group"
              >
              ...
              <a
                href="#sobre"
                className="border-2 border-white text-primary-white px-8 py-4 rounded-full font-semibold hover:bg-primary-white hover:text-primary-blue transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 shadow-lg hover:shadow-white/25"
              >
                Saiba Mais
              </a>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="col-span-1 md:col-span-2">
                <div className="flex items-center space-x-3 mb-4">
                  <div className="">
                    <Image className="h-16 w-16 rounded-lg" height={500} width={500} src={"/logo.png"} alt={'Logo'} />
                  </div>
                  <div>
